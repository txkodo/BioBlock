...
// import { JavaElement } from "../model/types/java_model";
// import { Counter } from "../util/counter";
// import { mcPath } from "../util/datapack";
// import { Path } from "../util/folder";
// import { float_round } from "../util/number";
// import { constructMatrix, deconstructMatrix, matrix, matrix_mul, relativeOrigin, UNIT_MATRIX, vec3, vec3_add, vec3_neg, vec3_sub } from "../util/vector";
...
//         this.elements.push(itemModels.find(model => model.elements === child) as CEItemModel)
//       } else {
...
//   constructor(entity: CE, elements: JavaElement[], entitymodel_folder:Path, textures_folder:Path, entity_name: string, part_id: string, custom_model_data: number) {
//     this.entity = entity
...
//     const added = vec3_add(this.elements.from,this.elements.to)
//     this.origin = [added[0]/2,added[1]/2,added[2]/2]
//   }

//   exportSummonCommand() {
//     return `summon armor_stand ~ ~ ~ {Tags:[${TAG_TEMP},${this.tag},${TAG_ALL}],Small:1b,Marker:1b,Invisible:1b,NoBasePlate:1b,ArmorItems:[{},{},{},{id:"${this.entity.pack.model_item}",Count:1b,tag:{CustomModelData:${this.custom_model_data}}}]}`
//   }

//   exportTpCommand(origin_matrix: matrix): string[] {
//     const matrix = matrix_mul(origin_matrix, constructMatrix([this.origin[0],this.origin[1],-this.origin[2]],this.elements.rotation))
...
//     (Object.keys(this.elements.faces) as itemModelFaceKey[]).forEach((facename: itemModelFaceKey): void => {
//       const face = this.elements.faces[facename] as face
...
//       elements: [{
//         from: vec3_add(vec3_sub(this.elements.from, this.origin), [8, 0, 8]),
//         to: vec3_add(vec3_sub(this.elements.to, this.origin), [8, 0, 8]),
//         faces: faces
//       }],
//       textures: textures,
//       display: {
